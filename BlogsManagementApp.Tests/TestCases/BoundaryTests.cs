...
namespace BlogsManagementApp.Tests.TestCases
{
    public class BoundaryTests
    {
        ...
        [Fact]
        public async Task<bool> Testfor_Blogs_Name_NotEmpty()
        {
            //Arrange
            bool res = false;
            ...
            try
            {
                ...
                var actualLength = _blogs.Name.ToString().Length;
        ...
        [Fact]
        public async Task<bool> Testfor_Blogs_Description_NotEmpty()
        {
            //Arrange
            bool res = false;
            string testName; string status;
            ...
            try
            {
                blogsservice.Setup(repo => repo.CreateBlogs(_blogs)).ReturnsAsync(_blogs);
                var result = await _blogsService.CreateBlogs(_blogs);
                var actualLength = _blogs.Description.ToString().Length;
